...
Example: If a PRD says "local-first with SQLite", design it as Go backend with GORM + SQLite and React 19 frontend via Tauri/Capacitor, NOT as a client-side-only SQLite app.
</HARD-GATE>
...
- Propose 2-3 different approaches with trade-offs — these are FEATURE/ARCHITECTURE approaches within the fixed tech stack, NOT alternative technology choices
- Present options conversationally with your recommendation and reasoning
- Lead with your recommended option and explain why
- If the user's PRD references technologies outside the HZ stack, acknowledge the PRD's intent but map the solution to the fixed tech stack (Go + React 19 + Tauri + Capacitor)
